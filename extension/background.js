...
function refresh(){ 
	...
	console.log("url:" + url);
	if (url != "https://letterboxd.com/activity/" && !url.startsWith("https://letterboxd.com/yuexinisme/friends/film/")
		&& !url.startsWith("https://letterboxd.com/yuexinisme/following/page/"))
		return;
	console.log("matched")
	if (url.startsWith("https://letterboxd.com/yuexinisme/following/page/")) {
